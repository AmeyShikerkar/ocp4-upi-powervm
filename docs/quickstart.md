 ...
 * `upgrade_image` : (Optional) Release image for OpenShift upgrade. If set, OCP cluster will be upgraded to this release image. (e.g. `"quay.io/openshift-release-dev/ocp-release-nightly@sha256:xxxxx"`)
